...
for params in param_grid:
    ...
    print("Cross-validated XGBClassifier ({}) in {} seconds.".format(params, end - start))
    ...
    if avg_err < best_avg_err:
        ...
        best_xgb_params_avg = params.copy()
    if worstgp_err < best_worstgp_err:
        best_worstgp_err = worstgp_err
        best_xgb_params_worstgp = params.copy()
